      ...
      <div className="img-container">
        ...
        <div className="text-holder">
          <div className="text">
            ...
            nothing gonna stop us. non no more. For the start until the end of
            the week we got to understand The main Job for the whole time which
            is drone designing. Then we we gain familiarity with various tools
            and devices That we are going to use during that time. The main
            thing is that we installed different software programs for
            programming, designing and simulation.
          </div>
        </div>
